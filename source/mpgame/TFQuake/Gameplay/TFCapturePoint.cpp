...
CLASS_DECLARATION( idEntity, TFCapturePoint )
	EVENT( EV_DropToFloor,		TFCapturePoint::Event_DropToFloor )
	EVENT( EV_Touch,			TFCapturePoint::Event_Touch )
	EVENT( EV_Activate,			TFCapturePoint::Event_Trigger )
	EVENT( EV_RespawnItem,		TFCapturePoint::Event_Respawn )
	EVENT( EV_RespawnFx,		TFCapturePoint::Event_RespawnFx )
// RAVEN BEGIN
// abahr
	EVENT( EV_SetGravity,		TFCapturePoint::Event_SetGravity )
// RAVEN END
...
//SD BEGIN
bool TFCapturePoint::ChangeOwnership(ETeamColor ColorTo, float Amount) {
	if(ColorTo == OwningTeam) {
		if(Ownership < 1.0) {
			Ownership += Amount;
			return true;
		}
...
ETeamColor TFCapturePoint::GetOwnership(float& CurrentOwnership) {
...
================
*/
void TFCapturePoint::Save( idSaveGame *savefile ) const {
...
/*
================
TFCapturePoint::Restore
================
*/
void TFCapturePoint::Restore( idRestoreGame *savefile ) {
...
/*
================
TFCapturePoint::UpdateRenderEntity
================
*/
bool TFCapturePoint::UpdateRenderEntity( renderEntity_s *renderEntity, const renderView_t *renderView ) const {
	if( simpleItem ) {
		return false;
	}
...
/*
================
TFCapturePoint::UpdateTrigger
================
*/
void TFCapturePoint::UpdateTrigger ( void ) {
...
/*
================
TFCapturePoint::ModelCallback
================
*/
bool TFCapturePoint::ModelCallback( renderEntity_t *renderEntity, const renderView_t *renderView ) {
	const TFCapturePoint *ent;
	...
	ent = static_cast<TFCapturePoint *>(gameLocal.entities[ renderEntity->entityNum ]);
	if ( !ent ) {
		gameLocal.Error( "TFCapturePoint::ModelCallback: callback with NULL game entity" );
	}
...
/*
================
TFCapturePoint::GetPhysicsToVisualTransform
================
*/
bool TFCapturePoint::GetPhysicsToVisualTransform( idVec3 &origin, idMat3 &axis ) {
	if( simpleItem ) {
...
/*
================
TFCapturePoint::Collide
================
*/
bool TFCapturePoint::Collide( const trace_t &collision, const idVec3 &velocity ) {
	idEntity* lol = gameLocal.entities[ collision.c.entityNum ];
	if ( gameLocal.isMultiplayer && collision.c.contents & CONTENTS_ITEMCLIP && lol && !lol->IsType( TFCapturePoint::GetClassType() ) ) {
...
/*
================
TFCapturePoint::Think
================
*/
void TFCapturePoint::Think( void ) {
...
/*
================
TFCapturePoint::Present
================
*/
void TFCapturePoint::Present( void ) {
	idEntity::Present();
	...
	if ( !fl.hidden && pulse ) {
		...
		shell.callback = TFCapturePoint::ModelCallback;
...
/*
================
TFCapturePoint::InstanceJoin
================
*/
void TFCapturePoint::InstanceJoin( void ) {
...
/*
================
TFCapturePoint::InstanceLeave
================
*/
void TFCapturePoint::InstanceLeave( void ) {
...
/*
================
TFCapturePoint::Spawn
================
*/
void TFCapturePoint::Spawn( void ) {
	idStr		giveTo;
	idEntity *	ent;
	idVec3		vSize;
...
/*
================
TFCapturePoint::Event_SetGravity
================
*/
void TFCapturePoint::Event_SetGravity() {
...
/*
================
TFCapturePoint::GetAttributes
================
*/
void TFCapturePoint::GetAttributes( idDict &attributes ) {
	int					i;
...
/*
================
TFCapturePoint::GiveToPlayer
================
*/
bool TFCapturePoint::GiveToPlayer( idPlayer *player ) {
	if ( player == NULL ) {
		return false;
	}
...
/*
===============
TFCapturePoint::SendPickupMsg
===============
*/
void TFCapturePoint::SendPickupMsg( int clientNum ) {
	idBitMsg	msg;
...
/*
================
TFCapturePoint::Pickup
================
*/
bool TFCapturePoint::Pickup( idPlayer *player ) {
	//dropped weapon?
	...
	if ( player == NULL || ( givenToPlayer != -1 && givenToPlayer != player->entityNumber ) ) {
		// idPlayer::GiveItem spawns an TFCapturePoint for pickup, which appears at the origin before being picked
...
/*
================
TFCapturePoint::ClientStale
================
*/
bool TFCapturePoint::ClientStale( void ) {
...
/*
================
TFCapturePoint::ClientUnstale
================
*/
void TFCapturePoint::ClientUnstale( void ) {
...
/*
================
TFCapturePoint::ClientPredictionThink
================
*/
void TFCapturePoint::ClientPredictionThink( void ) {
...
/*
================
TFCapturePoint::WriteFromSnapshot
================
*/
void TFCapturePoint::WriteToSnapshot( idBitMsgDelta &msg ) const {
	if ( syncPhysics ) {
...
/*
================
TFCapturePoint::ReadFromSnapshot
================
*/
void TFCapturePoint::ReadFromSnapshot( const idBitMsgDelta &msg ) {
	if ( syncPhysics ) {
...
/*
================
TFCapturePoint::Event_Pickup
================
*/
void TFCapturePoint::Event_Pickup( int clientNum ) {
	idPlayer *player;
...
/*
================
TFCapturePoint::ClientReceiveEvent
================
*/
bool TFCapturePoint::ClientReceiveEvent( int event, int time, const idBitMsg &msg ) {
	switch( event ) {
		case EVENT_PICKUP: {
...
/*
================
TFCapturePoint::Event_DropToFloor
================
*/
void TFCapturePoint::Event_DropToFloor( void ) {
...
/*
================
TFCapturePoint::Event_Touch
================
*/
void TFCapturePoint::Event_Touch( idEntity *other, trace_t *trace ) {
// RAVEN BEGIN
...
/*
================
TFCapturePoint::Event_Trigger
================
*/
void TFCapturePoint::Event_Trigger( idEntity *activator ) {
...
/*
================
TFCapturePoint::Event_Respawn
================
*/
void TFCapturePoint::Event_Respawn( void ) {
...
/*
================
TFCapturePoint::Event_RespawnFx
================
*/
void TFCapturePoint::Event_RespawnFx( void ) {
	idBitMsg	msg;
	byte		msgBuf[MAX_GAME_MESSAGE_SIZE];
...
CLASS_DECLARATION( TFCapturePoint, TFCapturePointPowerup )
END_CLASS

/*
================
TFCapturePointPowerup::TFCapturePointPowerup
================
*/
TFCapturePointPowerup::TFCapturePointPowerup() {
	time = 0;
...
/*
================
TFCapturePointPowerup::Save
================
*/
void TFCapturePointPowerup::Save( idSaveGame *savefile ) const {
...
/*
================
TFCapturePointPowerup::Restore
================
*/
void TFCapturePointPowerup::Restore( idRestoreGame *savefile ) {
...
/*
================
TFCapturePointPowerup::Spawn
================
*/
void TFCapturePointPowerup::Spawn( void ) {
...
/*
================
TFCapturePointPowerup::GiveToPlayer
================
*/
bool TFCapturePointPowerup::GiveToPlayer( idPlayer *player ) {
	...
	// in flavours of arena CTF (or are TFCapturePointPowerups only used in Arena? or even, are TFCapturePointPowerups MP only?), 
	...
	// also call TFCapturePoint::GiveToPlayer so any inv_* keywords get applied
	TFCapturePoint::GiveToPlayer( player );
...
/*
================
TFCapturePointPowerup::Think
================
*/
void TFCapturePointPowerup::Think( void ) {
	int i;

	// TFCapturePoint::Think() only needs to be called if we're spawned in
...
/*
================
TFCapturePointPowerup::Pickup
================
*/
bool TFCapturePointPowerup::Pickup( idPlayer* player ) {
	...
	pickup = TFCapturePoint::Pickup( player );
	if( unique ) {
		BecomeActive( TH_THINK );
	}
...
CLASS_DECLARATION( TFCapturePoint, idObjective )
...
CLASS_DECLARATION( TFCapturePoint, idMoveableItem )
...
===============================================================================
  ...
  TFCapturePointRemover

===============================================================================
*/

CLASS_DECLARATION( idEntity, TFCapturePointRemover )
	EVENT( EV_Activate,		TFCapturePointRemover::Event_Trigger )
END_CLASS

/*
================
TFCapturePointRemover::Spawn
================
*/
void TFCapturePointRemover::Spawn( void ) {
}

/*
================
TFCapturePointRemover::RemoveItem
================
*/
void TFCapturePointRemover::RemoveItem( idPlayer *player ) {
	const char *remove;
...
/*
================
TFCapturePointRemover::Event_Trigger
================
*/
void TFCapturePointRemover::Event_Trigger( idEntity *activator ) {
// RAVEN BEGIN
// jnewquist: Use accessor for static class type 
...
CLASS_DECLARATION( TFCapturePointRemover, idObjectiveComplete )
...
===============================================================================
*/
CLASS_DECLARATION( TFCapturePointRemover, rvObjectiveFailed )
...
CLASS_DECLARATION( TFCapturePoint, rvItemCTFFlag )
...
bool rvItemCTFFlag::Collide( const trace_t &collision, const idVec3 &velocity ) {
	...
	if ( collision.c.contents & CONTENTS_ITEMCLIP && lol && !lol->IsType( TFCapturePoint::GetClassType() ) ) {
		ResetFlag( powerup );
	}
	return false;
}
...
CLASS_DECLARATION( TFCapturePointPowerup, riDeadZonePowerup )
	EVENT( EV_ResetSpawn,		riDeadZonePowerup::Event_ResetSpawn )
END_CLASS

/*
================
riDeadZonePowerup::TFCapturePointPowerup
================
*/
...
bool riDeadZonePowerup::Pickup( idPlayer* player ) {
	...
	pickup = TFCapturePointPowerup::Pickup( player );
