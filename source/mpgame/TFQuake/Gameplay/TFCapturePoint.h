...
#ifndef __GAME_PAYLOAD_H__ 
#define __GAME_PAYLOAD_H__
...
class TFCapturePoint : public idEntity {
public:
	CLASS_PROTOTYPE( TFCapturePoint );

							TFCapturePoint();
	virtual					~TFCapturePoint();
...
// SD BEGIN
	float				Ownership;
	ETeamColor			OwningTeam;

	bool				ChangeOwnership(ETeamColor ColorTo, float Amount);
	ETeamColor			GetOwnership(float& CurrentOwnership);
// SD END
	enum {
...
protected:
	...
	idClipModel *			trigger;
	bool					spin;
	// only a small subset of TFCapturePoint need their physics object synced
	bool					syncPhysics;
...
class TFCapturePointPowerup : public TFCapturePoint {
public:
	CLASS_PROTOTYPE( TFCapturePointPowerup );
...
class riDeadZonePowerup : public TFCapturePointPowerup {
public:
...
class rvItemCTFFlag : public TFCapturePoint {
public:
...
class idObjective : public TFCapturePoint {
public:
...
class idMoveableItem : public TFCapturePoint {
public:
...
class TFCapturePointRemover : public idEntity {
public:
	CLASS_PROTOTYPE( TFCapturePointRemover );
...
class idObjectiveComplete : public TFCapturePointRemover {
public:
...
class rvObjectiveFailed : public TFCapturePointRemover {
public:
