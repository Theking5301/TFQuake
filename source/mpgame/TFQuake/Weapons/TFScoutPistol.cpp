...
class TFScoutPistol : public rvWeapon {
public:

	CLASS_PROTOTYPE( TFScoutPistol );
...
private:
	...
	CLASS_STATES_PROTOTYPE ( TFScoutPistol );
};

CLASS_DECLARATION( rvWeapon, TFScoutPistol )
END_CLASS

/*
================
TFScoutPistol::TFScoutPistol
================
*/
TFScoutPistol::TFScoutPistol ( void ) {
}

/*
================
TFScoutPistol::UpdateFlashlight
================
*/
bool TFScoutPistol::UpdateFlashlight ( void ) {
	if ( !wsfl.flashlight ) {
		return false;
	}
...
/*
================
TFScoutPistol::Flashlight
================
*/
void TFScoutPistol::Flashlight ( bool on ) {
	owner->Flashlight ( on );
...
/*
================
TFScoutPistol::UpdateAttack
================
*/
bool TFScoutPistol::UpdateAttack ( void ) {
	// Clear fire forced
	if ( fireForced ) {
		if ( !wsfl.attack ) {
			fireForced = false;
...
================
*/
void TFScoutPistol::Save ( idSaveGame *savefile ) const {
...
/*
================
TFScoutPistol::Restore
================
*/
void TFScoutPistol::Restore ( idRestoreGame *savefile ) {
...
/*
================
TFScoutPistol::PreSave
================
*/
void TFScoutPistol::PreSave ( void ) {
...
/*
================
TFScoutPistol::PostSave
================
*/
void TFScoutPistol::PostSave ( void ) {
}
...
CLASS_STATES_DECLARATION ( TFScoutPistol )
	STATE ( "Raise",						TFScoutPistol::State_Raise )
	STATE ( "Lower",						TFScoutPistol::State_Lower )
	STATE ( "Idle",							TFScoutPistol::State_Idle)
	STATE ( "Charge",						TFScoutPistol::State_Charge )
	STATE ( "Charged",						TFScoutPistol::State_Charged )
	STATE ( "Fire",							TFScoutPistol::State_Fire )
	STATE ( "Flashlight",					TFScoutPistol::State_Flashlight )
END_CLASS_STATES

/*
================
TFScoutPistol::State_Raise
================
*/
stateResult_t TFScoutPistol::State_Raise( const stateParms_t& parms ) {
	enum {
		RAISE_INIT,
		RAISE_WAIT,
	};	
...
/*
================
TFScoutPistol::State_Lower
================
*/
stateResult_t TFScoutPistol::State_Lower ( const stateParms_t& parms ) {
	enum {
		LOWER_INIT,
		LOWER_WAIT,
		LOWER_WAITRAISE
...
/*
================
TFScoutPistol::State_Idle
================
*/
stateResult_t TFScoutPistol::State_Idle ( const stateParms_t& parms ) {	
	enum {
		IDLE_INIT,
		IDLE_WAIT,
	};	
...
/*
================
TFScoutPistol::State_Charge
================
*/
stateResult_t TFScoutPistol::State_Charge ( const stateParms_t& parms ) {
	enum {
		CHARGE_INIT,
		CHARGE_WAIT,
	};	
...
/*
================
TFScoutPistol::State_Charged
================
*/
stateResult_t TFScoutPistol::State_Charged ( const stateParms_t& parms ) {
	enum {
		CHARGED_INIT,
		CHARGED_WAIT,
	};	
...
/*
================
TFScoutPistol::State_Fire
================
*/
stateResult_t TFScoutPistol::State_Fire ( const stateParms_t& parms ) {
	enum {
		FIRE_INIT,
		FIRE_WAIT,
	};	
...
/*
================
TFScoutPistol::State_Flashlight
================
*/
stateResult_t TFScoutPistol::State_Flashlight ( const stateParms_t& parms ) {
	enum {
		FLASHLIGHT_INIT,
		FLASHLIGHT_WAIT,
	};	
