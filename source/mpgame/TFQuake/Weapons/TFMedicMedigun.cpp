...
class TFMedicMedigun : public rvWeapon {
public:

	CLASS_PROTOTYPE( TFMedicMedigun );
...
private:
	...
	CLASS_STATES_PROTOTYPE ( TFMedicMedigun );
};

CLASS_DECLARATION( rvWeapon, TFMedicMedigun )
EVENT( EV_Lightninggun_RestoreHum,			TFMedicMedigun::Event_RestoreHum )
END_CLASS

/*
================
TFMedicMedigun::TFMedicMedigun
================
*/
TFMedicMedigun::TFMedicMedigun( void ) {
}
...
/*
================
TFMedicMedigun::Spawn
================
*/
void TFMedicMedigun::Spawn( void ) {
	int i;
...
================
*/
void TFMedicMedigun::Save	( idSaveGame* savefile ) const {
	int i;
...
/*
================
TFMedicMedigun::Restore
================
*/
void TFMedicMedigun::Restore ( idRestoreGame* savefile ) {
	int   i;
	int   num;
	float f;
...
/*
================
TFMedicMedigun::Think
================
*/
void TFMedicMedigun::Think ( void ) {
	trace_t	  tr;
...
/*
================
TFMedicMedigun::Attack
================
*/
void TFMedicMedigun::Attack ( idEntity* ent, const idVec3& dir, float power ) {
	// Double check
...
/*
================
TFMedicMedigun::UpdateChainLightning
================
*/
void TFMedicMedigun::UpdateChainLightning ( void ) {
	int					i;
...
/*
================
TFMedicMedigun::UpdateEffects
================
*/
void TFMedicMedigun::UpdateEffects( const idVec3& origin ) {
	int					i;
	rvLightningPath*	parent;
	idVec3				dir;
...
/*
================
TFMedicMedigun::UpdateTrailEffect
================
*/
void TFMedicMedigun::UpdateTrailEffect( rvClientEffectPtr& effect, const idVec3& start, const idVec3& end, bool view ) {
	idVec3 dir;
	dir = end - start;
	dir.Normalize();
...
/*
================
TFMedicMedigun::StopChainLightning
================
*/
void TFMedicMedigun::StopChainLightning( void ) {
	int	i;
...
/*
================
TFMedicMedigun::ClientStale
================
*/
void TFMedicMedigun::ClientStale( void ) {
...
/*
================
TFMedicMedigun::PreSave
================
*/
void TFMedicMedigun::PreSave( void ) {
...
/*
================
TFMedicMedigun::PostSave
================
*/
void TFMedicMedigun::PostSave( void ) {
	//restore the humming
...
/*
================
TFMedicMedigun::UpdateTubes
================
*/
void TFMedicMedigun::UpdateTubes( void ) {
	idAnimator* animator;
...
CLASS_STATES_DECLARATION ( TFMedicMedigun )
	STATE ( "Raise",						TFMedicMedigun::State_Raise )
	STATE ( "Lower",						TFMedicMedigun::State_Lower )
	STATE ( "Idle",							TFMedicMedigun::State_Idle)
	STATE ( "Fire",							TFMedicMedigun::State_Fire )
END_CLASS_STATES

/*
================
TFMedicMedigun::State_Raise
================
*/
stateResult_t TFMedicMedigun::State_Raise( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};	
...
/*
================
TFMedicMedigun::State_Lower
================
*/
stateResult_t TFMedicMedigun::State_Lower( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
		STAGE_WAITRAISE
...
/*
================
TFMedicMedigun::State_Idle
================
*/
stateResult_t TFMedicMedigun::State_Idle( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};	
...
/*
================
TFMedicMedigun::State_Fire
================
*/
stateResult_t TFMedicMedigun::State_Fire( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_ATTACKLOOP,
		STAGE_DONE,
...
/*
================
TFMedicMedigun::Event_RestoreHum
================
*/
void TFMedicMedigun::Event_RestoreHum ( void ) {
	StopSound( SND_CHANNEL_BODY3, false );
	StartSound( "snd_idle_hum", SND_CHANNEL_BODY3, 0, false, NULL );
}
...
/*
================
TFMedicMedigun::ClientUnStale
================
*/
void TFMedicMedigun::ClientUnstale( void ) {
	Event_RestoreHum();
}
