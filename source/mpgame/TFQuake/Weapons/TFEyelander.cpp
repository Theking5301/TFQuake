...
class TFEyelander : public rvWeapon {
public:

	CLASS_PROTOTYPE( TFEyelander );
...
private:
	...
	CLASS_STATES_PROTOTYPE ( TFEyelander );
};

CLASS_DECLARATION( rvWeapon, TFEyelander )
END_CLASS

/*
================
TFEyelander::TFEyelander
================
*/
TFEyelander::TFEyelander( void ) {
	loopSound = LOOP_NONE;
}
...
================
*/
void TFEyelander::Save ( idSaveGame *savefile ) const {
...
================
*/
void TFEyelander::Restore ( idRestoreGame *savefile ) {
...
================
*/
void TFEyelander::PreSave ( void ) {

}

/*
================
TFEyelander::PostSave
================
*/
void TFEyelander::PostSave( void ) {
}

void TFEyelander::PlayLoopSound( int sndType ) {
...
/*
================
TFEyelander::CleanupWeapon
================
*/
void TFEyelander::CleanupWeapon( void ) {
	...
	if ( gameLocal.time > nextAttackTime ) {					
		if ( ent ) {
			if ( ent->fl.takedamage ) {
				...
				if( ent->health <= 0) {
					if(owner->demoHeads < 5) {
						owner->demoHeads++;
						owner->inventory.maxHealth += 15;
						int crouchedSpeed = 0;
						owner->setSpeed(owner->getMovementSpeeds(crouchedSpeed) + 5, crouchedSpeed+5); 
					}
				}
			} else {
				PlayLoopSound( LOOP_WALL );
...
/*
================
TFEyelander::StartBlade
================
*/
void TFEyelander::StartBlade ( void ) {
	if ( viewModel ) {
...
/*
================
TFEyelander::StopBlade
================
*/
void TFEyelander::StopBlade ( void ) {
	if ( viewModel ) {
...
CLASS_STATES_DECLARATION ( TFEyelander )
	STATE ( "Raise",		TFEyelander::State_Raise )
	STATE ( "Lower",		TFEyelander::State_Lower )
	STATE ( "Idle",			TFEyelander::State_Idle)
	STATE ( "Fire",			TFEyelander::State_Fire )
END_CLASS_STATES

/*
================
TFEyelander::State_Raise
================
*/
stateResult_t TFEyelander::State_Raise( const stateParms_t& parms ) {
	enum {
		RAISE_INIT,
		RAISE_WAIT,
	};	
...
/*
================
TFEyelander::State_Lower
================
*/
stateResult_t TFEyelander::State_Lower( const stateParms_t& parms ) {
	enum {
		LOWER_INIT,
		LOWER_WAIT,
		LOWER_WAITRAISE
...
/*
================
TFEyelander::State_Idle
================
*/
stateResult_t TFEyelander::State_Idle( const stateParms_t& parms ) {
	enum {
		IDLE_INIT,
		IDLE_WAIT,
	};	
...
/*
================
TFEyelander::State_Fire
================
*/
stateResult_t TFEyelander::State_Fire( const stateParms_t& parms ) {
	enum {
		STAGE_START,
		STAGE_START_WAIT,
		STAGE_LOOP,
