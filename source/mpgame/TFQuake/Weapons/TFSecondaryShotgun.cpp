...
class TFSecondaryShotgun : public rvWeapon {
public:

	CLASS_PROTOTYPE( TFSecondaryShotgun );

	TFSecondaryShotgun ( void );
...
private:
	...
	CLASS_STATES_PROTOTYPE( TFSecondaryShotgun );
};

CLASS_DECLARATION( rvWeapon, TFSecondaryShotgun )
END_CLASS

/*
================
TFSecondaryShotgun::TFSecondaryShotgun
================
*/
TFSecondaryShotgun::TFSecondaryShotgun( void ) {
}

/*
================
TFSecondaryShotgun::Spawn
================
*/
void TFSecondaryShotgun::Spawn( void ) {
...
/*
================
TFSecondaryShotgun::Save
================
*/
void TFSecondaryShotgun::Save( idSaveGame *savefile ) const {
}

/*
================
TFSecondaryShotgun::Restore
================
*/
void TFSecondaryShotgun::Restore( idRestoreGame *savefile ) {
	hitscans   = spawnArgs.GetFloat( "hitscans" );
}

/*
================
TFSecondaryShotgun::PreSave
================
*/
void TFSecondaryShotgun::PreSave ( void ) {
}

/*
================
TFSecondaryShotgun::PostSave
================
*/
void TFSecondaryShotgun::PostSave ( void ) {
}
...
CLASS_STATES_DECLARATION( TFSecondaryShotgun )
	STATE( "Idle",				TFSecondaryShotgun::State_Idle)
	STATE( "Fire",				TFSecondaryShotgun::State_Fire )
	STATE( "Reload",			TFSecondaryShotgun::State_Reload )
END_CLASS_STATES

/*
================
TFSecondaryShotgun::State_Idle
================
*/
stateResult_t TFSecondaryShotgun::State_Idle( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};	
...
/*
================
TFSecondaryShotgun::State_Fire
================
*/
stateResult_t TFSecondaryShotgun::State_Fire( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};	
...
/*
================
TFSecondaryShotgun::State_Reload
================
*/
stateResult_t TFSecondaryShotgun::State_Reload ( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
