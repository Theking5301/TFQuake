...
class TFSecondaryPistol : public rvWeapon {
public:

	CLASS_PROTOTYPE( TFSecondaryPistol );

	TFSecondaryPistol ( void );
...
CLASS_DECLARATION( rvWeapon, TFSecondaryPistol )
END_CLASS

/*
================
TFSecondaryPistol::TFSecondaryPistol
================
*/
TFSecondaryPistol::TFSecondaryPistol ( void ) {
}

/*
================
TFSecondaryPistol::UpdateFlashlight
================
*/
bool TFSecondaryPistol::UpdateFlashlight ( void ) {
	if ( !wsfl.flashlight ) {
		return false;
	}
...
/*
================
TFSecondaryPistol::Flashlight
================
*/
void TFSecondaryPistol::Flashlight ( bool on ) {
	owner->Flashlight ( on );
...
/*
================
TFSecondaryPistol::UpdateAttack
================
*/
bool TFSecondaryPistol::UpdateAttack ( void ) {
	// Clear fire forced
	if ( fireForced ) {
		if ( !wsfl.attack ) {
			fireForced = false;
...
/*
================
TFSecondaryPistol::Spawn
================
*/
void TFSecondaryPistol::Spawn ( void ) {
...
/*
================
TFSecondaryPistol::Save
================
*/
void TFSecondaryPistol::Save ( idSaveGame *savefile ) const {
...
/*
================
TFSecondaryPistol::Restore
================
*/
void TFSecondaryPistol::Restore ( idRestoreGame *savefile ) {
...
/*
================
TFSecondaryPistol::PreSave
================
*/
void TFSecondaryPistol::PreSave ( void ) {
...
/*
================
TFSecondaryPistol::PostSave
================
*/
void TFSecondaryPistol::PostSave ( void ) {
}
...
CLASS_STATES_DECLARATION ( TFSecondaryPistol )
	STATE ( "Raise",						TFSecondaryPistol::State_Raise )
	STATE ( "Lower",						TFSecondaryPistol::State_Lower )
	STATE ( "Idle",							TFSecondaryPistol::State_Idle)
	STATE ( "Charge",						TFSecondaryPistol::State_Charge )
...
/*
================
TFSecondaryPistol::State_Raise
================
*/
stateResult_t TFSecondaryPistol::State_Raise( const stateParms_t& parms ) {
	enum {
		RAISE_INIT,
		RAISE_WAIT,
	};	
...
/*
================
TFSecondaryPistol::State_Lower
================
*/
stateResult_t TFSecondaryPistol::State_Lower ( const stateParms_t& parms ) {
	enum {
		LOWER_INIT,
		LOWER_WAIT,
		LOWER_WAITRAISE
...
================
*/
stateResult_t TFSecondaryPistol::State_Idle ( const stateParms_t& parms ) {	
	enum {
		IDLE_INIT,
		IDLE_WAIT,
	};	
...
================
*/
stateResult_t TFSecondaryPistol::State_Charge ( const stateParms_t& parms ) {
	enum {
		CHARGE_INIT,
		CHARGE_WAIT,
	};	
...
/*
================
TFSecondaryPistol::State_Charged
================
*/
stateResult_t TFSecondaryPistol::State_Charged ( const stateParms_t& parms ) {
	enum {
		CHARGED_INIT,
		CHARGED_WAIT,
	};	
...
/*
================
TFSecondaryPistol::State_Fire
================
*/
stateResult_t TFSecondaryPistol::State_Fire ( const stateParms_t& parms ) {
	enum {
		FIRE_INIT,
		FIRE_WAIT,
	};	
...
/*
================
TFSecondaryPistol::State_Flashlight
================
*/
stateResult_t TFSecondaryPistol::State_Flashlight ( const stateParms_t& parms ) {
	enum {
		FLASHLIGHT_INIT,
		FLASHLIGHT_WAIT,
	};	
