...
class TFPyroFlamethrower : public rvWeapon {
public:

	CLASS_PROTOTYPE( TFPyroFlamethrower );

	TFPyroFlamethrower( void );
	~TFPyroFlamethrower( void );
...
private:
	...
	CLASS_STATES_PROTOTYPE ( TFPyroFlamethrower );
};

CLASS_DECLARATION( rvWeapon, TFPyroFlamethrower )
EVENT( EV_Lightninggun_RestoreHum,			TFPyroFlamethrower::Event_RestoreHum )
END_CLASS

/*
================
TFPyroFlamethrower::TFPyroFlamethrower
================
*/
TFPyroFlamethrower::TFPyroFlamethrower( void ) {
}
...
/*
================
TFPyroFlamethrower::Spawn
================
*/
void TFPyroFlamethrower::Spawn( void ) {
	int i;
...
/*
================
TFPyroFlamethrower::Save
================
*/
void TFPyroFlamethrower::Save	( idSaveGame* savefile ) const {
	int i;
...
/*
================
TFPyroFlamethrower::Restore
================
*/
void TFPyroFlamethrower::Restore ( idRestoreGame* savefile ) {
	int   i;
	int   num;
	float f;
...
/*
================
TFPyroFlamethrower::Think
================
*/
void TFPyroFlamethrower::Think ( void ) {
	trace_t	  tr;
...
/*
================
TFPyroFlamethrower::Attack
================
*/
void TFPyroFlamethrower::Attack ( idEntity* ent, const idVec3& dir, float power ) {
	// Double check
...
/*
================
TFPyroFlamethrower::UpdateChainLightning
================
*/
void TFPyroFlamethrower::UpdateChainLightning ( void ) {
	int					i;
...
/*
================
TFPyroFlamethrower::UpdateEffects
================
*/
void TFPyroFlamethrower::UpdateEffects( const idVec3& origin ) {
	int					i;
	rvLightningPath*	parent;
	idVec3				dir;
...
/*
================
TFPyroFlamethrower::UpdateTrailEffect
================
*/
void TFPyroFlamethrower::UpdateTrailEffect( rvClientEffectPtr& effect, const idVec3& start, const idVec3& end, bool view ) {
	idVec3 dir;
	dir = end - start;
	dir.Normalize();
...
/*
================
TFPyroFlamethrower::StopChainLightning
================
*/
void TFPyroFlamethrower::StopChainLightning( void ) {
	int	i;
...
/*
================
TFPyroFlamethrower::ClientStale
================
*/
void TFPyroFlamethrower::ClientStale( void ) {
...
/*
================
TFPyroFlamethrower::PreSave
================
*/
void TFPyroFlamethrower::PreSave( void ) {
...
/*
================
TFPyroFlamethrower::PostSave
================
*/
void TFPyroFlamethrower::PostSave( void ) {
	//restore the humming
...
/*
================
TFPyroFlamethrower::UpdateTubes
================
*/
void TFPyroFlamethrower::UpdateTubes( void ) {
	idAnimator* animator;
...
CLASS_STATES_DECLARATION ( TFPyroFlamethrower )
	STATE ( "Raise",						TFPyroFlamethrower::State_Raise )
	STATE ( "Lower",						TFPyroFlamethrower::State_Lower )
	STATE ( "Idle",							TFPyroFlamethrower::State_Idle)
	STATE ( "Fire",							TFPyroFlamethrower::State_Fire )
END_CLASS_STATES

/*
================
TFPyroFlamethrower::State_Raise
================
*/
stateResult_t TFPyroFlamethrower::State_Raise( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};	
...
/*
================
TFPyroFlamethrower::State_Lower
================
*/
stateResult_t TFPyroFlamethrower::State_Lower( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
		STAGE_WAITRAISE
...
/*
================
TFPyroFlamethrower::State_Idle
================
*/
stateResult_t TFPyroFlamethrower::State_Idle( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};	
...
/*
================
TFPyroFlamethrower::State_Fire
================
*/
stateResult_t TFPyroFlamethrower::State_Fire( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_ATTACKLOOP,
		STAGE_DONE,
...
/*
================
TFPyroFlamethrower::Event_RestoreHum
================
*/
void TFPyroFlamethrower::Event_RestoreHum ( void ) {
	StopSound( SND_CHANNEL_BODY3, false );
	StartSound( "snd_idle_hum", SND_CHANNEL_BODY3, 0, false, NULL );
}
...
/*
================
TFPyroFlamethrower::ClientUnStale
================
*/
void TFPyroFlamethrower::ClientUnstale( void ) {
	Event_RestoreHum();
}
