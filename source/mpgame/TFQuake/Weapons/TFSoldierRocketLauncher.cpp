...
class TFSoldierRocketLauncher : public rvWeapon {
public:

	CLASS_PROTOTYPE( TFSoldierRocketLauncher );

	TFSoldierRocketLauncher ( void );
	~TFSoldierRocketLauncher ( void );
...
private:
	...
	CLASS_STATES_PROTOTYPE ( TFSoldierRocketLauncher );
};

CLASS_DECLARATION( rvWeapon, TFSoldierRocketLauncher )
END_CLASS

/*
================
TFSoldierRocketLauncher::TFSoldierRocketLauncher
================
*/
TFSoldierRocketLauncher::TFSoldierRocketLauncher ( void ) {
}
...
/*
================
TFSoldierRocketLauncher::Spawn
================
*/
void TFSoldierRocketLauncher::Spawn ( void ) {
	float f;
...
/*
================
TFSoldierRocketLauncher::Think
================
*/
void TFSoldierRocketLauncher::Think ( void ) {	
	trace_t	tr;
	int		i;
...
/*
================
TFSoldierRocketLauncher::OnLaunchProjectile
================
*/
void TFSoldierRocketLauncher::OnLaunchProjectile ( idProjectile* proj ) {
...
/*
================
TFSoldierRocketLauncher::SetRocketState
================
*/
void TFSoldierRocketLauncher::SetRocketState ( const char* state, int blendFrames ) {
	rocketThread.SetState ( state, blendFrames );
}

/*
=====================
TFSoldierRocketLauncher::Save
=====================
*/
void TFSoldierRocketLauncher::Save( idSaveGame *saveFile ) const {
...
/*
=====================
TFSoldierRocketLauncher::Restore
=====================
*/
void TFSoldierRocketLauncher::Restore( idRestoreGame *saveFile ) {
	int numEnts = 0;
	idEntity* ent = NULL;
...
/*
================
TFSoldierRocketLauncher::PreSave
================
*/
void TFSoldierRocketLauncher::PreSave ( void ) {
}

/*
================
TFSoldierRocketLauncher::PostSave
================
*/
void TFSoldierRocketLauncher::PostSave ( void ) {
}
...
CLASS_STATES_DECLARATION ( TFSoldierRocketLauncher )
	STATE ( "Idle",				TFSoldierRocketLauncher::State_Idle)
	STATE ( "Fire",				TFSoldierRocketLauncher::State_Fire )
	STATE ( "Raise",			TFSoldierRocketLauncher::State_Raise )
	STATE ( "Lower",			TFSoldierRocketLauncher::State_Lower )

	STATE ( "Rocket_Idle",		TFSoldierRocketLauncher::State_Rocket_Idle )
	STATE ( "Rocket_Reload",	TFSoldierRocketLauncher::State_Rocket_Reload )
	
	STATE ( "AddToClip",		TFSoldierRocketLauncher::Frame_AddToClip )
END_CLASS_STATES


/*
================
TFSoldierRocketLauncher::State_Raise

Raise the weapon
================
*/
stateResult_t TFSoldierRocketLauncher::State_Raise ( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};	
...
/*
================
TFSoldierRocketLauncher::State_Lower

Lower the weapon
================
*/
stateResult_t TFSoldierRocketLauncher::State_Lower ( const stateParms_t& parms ) {	
	enum {
		STAGE_INIT,
		STAGE_WAIT,
		STAGE_WAITRAISE
...
/*
================
TFSoldierRocketLauncher::State_Idle
================
*/
stateResult_t TFSoldierRocketLauncher::State_Idle( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};	
...
/*
================
TFSoldierRocketLauncher::State_Fire
================
*/
stateResult_t TFSoldierRocketLauncher::State_Fire ( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};	
...
/*
================
TFSoldierRocketLauncher::State_Rocket_Idle
================
*/
stateResult_t TFSoldierRocketLauncher::State_Rocket_Idle ( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
		STAGE_WAITEMPTY,
...
/*
================
TFSoldierRocketLauncher::State_Rocket_Reload
================
*/
stateResult_t TFSoldierRocketLauncher::State_Rocket_Reload ( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};	
...
/*
================
TFSoldierRocketLauncher::Frame_AddToClip
================
*/
stateResult_t TFSoldierRocketLauncher::Frame_AddToClip ( const stateParms_t& parms ) {
	AddToClip ( 1 );
	return SRESULT_OK;
}
