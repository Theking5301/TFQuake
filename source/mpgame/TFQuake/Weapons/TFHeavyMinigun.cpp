...
public:
	...
	CLASS_PROTOTYPE( TFHeavyMinigun );
...
private:
	...
	CLASS_STATES_PROTOTYPE ( TFHeavyMinigun );
};

CLASS_DECLARATION( rvWeapon, TFHeavyMinigun )
END_CLASS

/*
================
TFHeavyMinigun::TFHeavyMinigun
================
*/
...
/*
================
TFHeavyMinigun::Spawn
================
*/
void TFHeavyMinigun::Spawn ( void ) {
...
================
*/
void TFHeavyMinigun::Save ( idSaveGame *savefile ) const {
...
/*
================
TFHeavyMinigun::Restore
================
*/
void TFHeavyMinigun::Restore ( idRestoreGame *savefile ) {
...
/*
================
TFHeavyMinigun::PreSave
================
*/
void TFHeavyMinigun::PreSave ( void ) {
...
/*
================
TFHeavyMinigun::PostSave
================
*/
void TFHeavyMinigun::PostSave ( void ) {
...
/*
================
TFHeavyMinigun::CancelGuide
================
*/
void TFHeavyMinigun::CancelGuide ( void ) {
	if ( zoomGui && guideEnt ) {
...
/*
================
TFHeavyMinigun::UpdateGuideStatus
================
*/
void TFHeavyMinigun::UpdateGuideStatus ( float range ) {
...
/*
================
TFHeavyMinigun::Think
================
*/
void TFHeavyMinigun::Think ( void ) {
	idEntity* ent;
	trace_t	  tr;
...
/*
================
TFHeavyMinigun::OnLaunchProjectile
================
*/
void TFHeavyMinigun::OnLaunchProjectile ( idProjectile* proj ) {
...
/*
================
TFHeavyMinigun::DrumSpin

Set the drum spin speed 
================
*/
bool TFHeavyMinigun::DrumSpin ( int speed, int blendFrames ) {
...
CLASS_STATES_DECLARATION ( TFHeavyMinigun )
	STATE ( "Raise",						TFHeavyMinigun::State_Raise )
	STATE ( "Lower",						TFHeavyMinigun::State_Lower )
	STATE ( "Idle",							TFHeavyMinigun::State_Idle)
	STATE ( "Fire",							TFHeavyMinigun::State_Fire )
	STATE ( "Reload",						TFHeavyMinigun::State_Reload )
	STATE ( "DrumSpinDown",					TFHeavyMinigun::State_DrumSpinDown )
	STATE ( "DrumSpinUp",					TFHeavyMinigun::State_DrumSpinUp )
	
	STATE ( "ClaspOpen",					TFHeavyMinigun::Frame_ClaspOpen )
	STATE ( "ClaspClose",					TFHeavyMinigun::Frame_ClaspClose )
END_CLASS_STATES

/*
================
TFHeavyMinigun::State_Raise

Raise the weapon
================
*/
stateResult_t TFHeavyMinigun::State_Raise ( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};	
...
/*
================
TFHeavyMinigun::State_Lower

Lower the weapon
================
*/
stateResult_t TFHeavyMinigun::State_Lower ( const stateParms_t& parms ) {	
	enum {
		STAGE_INIT,
		STAGE_WAIT,
		STAGE_WAITRAISE
...
/*
================
TFHeavyMinigun::State_Idle

Manage the idle state of the weapon
================
*/
stateResult_t TFHeavyMinigun::State_Idle( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};	
...
/*
================
TFHeavyMinigun::State_Fire

Fire the weapon
================
*/
stateResult_t TFHeavyMinigun::State_Fire( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_FIRE,
		STAGE_FIREWAIT,
...
/*
================
TFHeavyMinigun::State_Reload
================
*/
stateResult_t TFHeavyMinigun::State_Reload ( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_RELOAD,
		STAGE_RELOADWAIT,
...
/*
================
TFHeavyMinigun::State_DrumSpinUp

Spin the drum from a slow speed to a fast speed
================
*/
stateResult_t TFHeavyMinigun::State_DrumSpinUp ( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};	
...
/*
================
TFHeavyMinigun::State_DrumSpinDown

Spin the drum down from a faster speed
================
*/
stateResult_t TFHeavyMinigun::State_DrumSpinDown ( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};	
...
/*
================
TFHeavyMinigun::Frame_ClaspOpen

Open the clasp that holds in the clips
================
*/
stateResult_t TFHeavyMinigun::Frame_ClaspOpen ( const stateParms_t& parms ) {
...
================
*/
stateResult_t TFHeavyMinigun::Frame_ClaspClose ( const stateParms_t& parms ) {
	if ( mods & NAILGUN_MOD_ROF_AMMO ) {
