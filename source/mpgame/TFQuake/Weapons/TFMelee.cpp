...
class TFMelee : public rvWeapon {
public:

	CLASS_PROTOTYPE( TFMelee );
...
private:
	...
	CLASS_STATES_PROTOTYPE ( TFMelee );
};

CLASS_DECLARATION( rvWeapon, TFMelee )
END_CLASS
...
================
*/
void TFMelee::Save ( idSaveGame *savefile ) const {
...
================
*/
void TFMelee::Restore ( idRestoreGame *savefile ) {
...
================
*/
void TFMelee::PostSave( void ) {
}

void TFMelee::PlayLoopSound( int sndType ) {
...
/*
================
TFMelee::CleanupWeapon
================
*/
void TFMelee::CleanupWeapon( void ) {
...
CLASS_STATES_DECLARATION ( TFMelee )
	STATE ( "Raise",		TFMelee::State_Raise )
	STATE ( "Lower",		TFMelee::State_Lower )
	STATE ( "Idle",			TFMelee::State_Idle)
	STATE ( "Fire",			TFMelee::State_Fire )
END_CLASS_STATES
...
================
*/
stateResult_t TFMelee::State_Raise( const stateParms_t& parms ) {
	enum {
		RAISE_INIT,
		RAISE_WAIT,
	};	
...
================
*/
stateResult_t TFMelee::State_Lower( const stateParms_t& parms ) {
	enum {
		LOWER_INIT,
		LOWER_WAIT,
		LOWER_WAITRAISE
...
================
*/
stateResult_t TFMelee::State_Idle( const stateParms_t& parms ) {
	enum {
		IDLE_INIT,
		IDLE_WAIT,
	};	
...
================
*/
stateResult_t TFMelee::State_Fire( const stateParms_t& parms ) {
	enum {
		STAGE_START,
		STAGE_START_WAIT,
		STAGE_LOOP,
