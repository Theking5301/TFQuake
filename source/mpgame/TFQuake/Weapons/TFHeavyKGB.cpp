...
class TFHeavyKGB : public rvWeapon {
public:

	CLASS_PROTOTYPE( TFHeavyKGB );
...
private:
	...
	CLASS_STATES_PROTOTYPE ( TFHeavyKGB );
};

CLASS_DECLARATION( rvWeapon, TFHeavyKGB )
END_CLASS

/*
================
TFHeavyKGB::TFHeavyKGB
================
*/
TFHeavyKGB::TFHeavyKGB( void ) {
	loopSound = LOOP_NONE;
}
...
================
*/
void TFHeavyKGB::Save ( idSaveGame *savefile ) const {
...
================
*/
void TFHeavyKGB::Restore ( idRestoreGame *savefile ) {
...
================
*/
void TFHeavyKGB::PostSave( void ) {
}

void TFHeavyKGB::PlayLoopSound( int sndType ) {
...
/*
================
TFHeavyKGB::CleanupWeapon
================
*/
void TFHeavyKGB::CleanupWeapon( void ) {
...
/*
================
TFHeavyKGB::StartBlade
================
*/
void TFHeavyKGB::StartBlade ( void ) {
	if ( viewModel ) {
...
/*
================
TFHeavyKGB::StopBlade
================
*/
void TFHeavyKGB::StopBlade ( void ) {
	if ( viewModel ) {
...
CLASS_STATES_DECLARATION ( TFHeavyKGB )
	STATE ( "Raise",		TFHeavyKGB::State_Raise )
	STATE ( "Lower",		TFHeavyKGB::State_Lower )
	STATE ( "Idle",			TFHeavyKGB::State_Idle)
	STATE ( "Fire",			TFHeavyKGB::State_Fire )
END_CLASS_STATES

/*
================
TFHeavyKGB::State_Raise
================
*/
stateResult_t TFHeavyKGB::State_Raise( const stateParms_t& parms ) {
	enum {
		RAISE_INIT,
		RAISE_WAIT,
	};	
...
/*
================
TFHeavyKGB::State_Lower
================
*/
stateResult_t TFHeavyKGB::State_Lower( const stateParms_t& parms ) {
	enum {
		LOWER_INIT,
		LOWER_WAIT,
		LOWER_WAITRAISE
...
/*
================
TFHeavyKGB::State_Idle
================
*/
stateResult_t TFHeavyKGB::State_Idle( const stateParms_t& parms ) {
	enum {
		IDLE_INIT,
		IDLE_WAIT,
	};	
...
/*
================
TFHeavyKGB::State_Fire
================
*/
stateResult_t TFHeavyKGB::State_Fire( const stateParms_t& parms ) {
	enum {
		STAGE_START,
		STAGE_START_WAIT,
		STAGE_LOOP,
